...
class CitiesSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        $cities = [
            ...
            ['name' => 'London',         'country_id' => 2,  'lat' => 51.5098, 'lng' => 0.1278,  'created_at' => Carbon::now()->toDateTimeString(), 'updated_at' => Carbon::now()->toDateTimeString()],
            ...
            ['name' => 'Rio de Janeiro', 'country_id' => 10, 'lat' => 22.9068, 'lng' => 43.1729, 'created_at' => Carbon::now()->toDateTimeString(), 'updated_at' => Carbon::now()->toDateTimeString()],
            ['name' => 'Istanbul',       'country_id' => 3,  'lat' => 48.8566, 'lng' => 2.3522,  'created_at' => Carbon::now()->toDateTimeString(), 'updated_at' => Carbon::now()->toDateTimeString()],
            ['name' => 'Tokyo',          'country_id' => 7,  'lat' => 41.0082, 'lng' => 28.9784, 'created_at' => Carbon::now()->toDateTimeString(), 'updated_at' => Carbon::now()->toDateTimeString()],
            ...
            ['name' => 'Moscow',         'country_id' => 12, 'lat' => 55.7558, 'lng' => 37.6173, 'created_at' => Carbon::now()->toDateTimeString(), 'updated_at' => Carbon::now()->toDateTimeString()],
